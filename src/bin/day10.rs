...
mod part2 {
    ...
    struct MapTile { height: usize, coordinates: Point} impl MapTile {
        ...
        fn find_trailheads(map: &Vec<Vec<MapTile>>, start_position: Point) -> usize {
            ...
            let mut set_of_end_points: Vec<&MapTile> = Vec::new();
            ...
            while ! queue.is_empty() {
                ...
                let tile = & map[point.y][point.x];
                println!("Searching from {:?} which has height {}...", point, tile.height);
                if tile.height == 9 { set_of_end_points.push(tile); continue; }
...
mod tests {
    ...
    fn test_part2_simple() {
        assert_eq!(part2::solve("9990\n4321\n5992\n6543\n7114\n8765\n9111"), 3);
    }

    #[test]
    fn test_part2() {
        assert_eq!(part2::solve("89010123\n78121874\n87430965\n96549874\n45678903\n32019012\n01329801\n10456732"), 81);
    }
}
