...
mod part2 {
    ...
    /// off sets the unit conversion correction described in [part 2](https://adventofcode.com/2024/day/13#part2).
    const UNIT_CONVERSION_CORRECTION: i64 = 10000000000000;
    ...
    struct ClawMachine {
        ...
        fn solution(&self) -> Option<usize> {
            ...
            let b1 = self.b_button.moves_x as i64;
            let b2 = self.b_button.moves_y as i64;
            let c1 = self.prize_loc.x as i64 + UNIT_CONVERSION_CORRECTION;
            let c2 = self.prize_loc.y as i64 + UNIT_CONVERSION_CORRECTION;
